...
public class DLLCharacteristics {
    public static final int RESERVED_1 = 0x0001;
    public static final int RESERVED_2 = 0x0002;
    public static final int RESERVED_3 = 0x0004;
    public static final int RESERVED_4 = 0x0008;
